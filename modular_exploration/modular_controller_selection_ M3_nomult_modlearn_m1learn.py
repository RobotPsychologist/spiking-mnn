...
with model:
    ...
    #mult3_m3_conn = nengo.Connection(mult3, m3, function=mult)
    ...
    #m3_output_conn = nengo.Connection(m3, output_node) #, function=init_func, learning_rule_type=nengo.PES(learning_rate=1e-6))
