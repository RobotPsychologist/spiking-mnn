...
with model:
    ...
    controller = nengo.Ensemble(n_neurons=100, dimensions=3, label='controller') # The conroller should learn to send a [1,0] or [0,1] depending on the signal it is recieving.
    mult1 = nengo.Ensemble(n_neurons=100, dimensions=2, radius=2, label='mult1') # The ensemble that combines stim and controller
    mult2 = nengo.Ensemble(n_neurons=100, dimensions=2, radius=2, label='mult2') # The ensemble that combines stim and controller
    mult3 = nengo.Ensemble(n_neurons=100, dimensions=2, radius=2, label='mult3') # The ensemble that combines stim and controller
    ...
    nengo.Connection(stim_node, mult3[1]) # Connects the stimulus that multi will combine with the input from controller
    ...
    controller_mult3_conn = nengo.Connection(controller[2], mult3[0])    
